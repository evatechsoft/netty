...
class LeakAwareByteBuf extends WrappedByteBuf {

    private final ResourceLeak leak;

    public LeakAwareByteBuf(ByteBuf buf, ResourceLeak leak) {
        super(buf);
        this.leak = leak;
    }
    ...
    public String toString() {
        return StringUtil.simpleClassName(this) + '(' + super.toString() + ')';
    }
